...
if (!file.exists(station_exclude_list_file)) {
    stop("Station excluding list file does not exist:  ", station_exclude_list_file)
}
...
exclude_station_criteria <- 0.5
min_obs_ndays <- ceiling(exclude_station_criteria * ndays)
