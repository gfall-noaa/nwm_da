...
# Fetch National Water Model analysis/assim forcing data.

# Greg Fall, 2019-10-01 - adapted from get_nwm_ana_ext_forcing.sh
...
BUSY_FILE=ARCHIVE_NWM_V2.1_ANA_BUSY
MAX_INSTANCES=1
...
while [ $HOURS_BACK -ge 0 ] ; do
    ...
    REMOTE_DIR_URL="${URL}/forcing_analysis_assim"
    ...
    if [ $STATUS -ne 0 ] ; then
        ...
        DEST_DIR_CHILD=${DEST_DIR_PARENT}/forcing_analysis_assim
        ...
        while [ $TIME_MINUS -ge 0 ] ; do
            ...
            LOCAL_FILE="nwm.${CYCLE_DATE_YYYYMMDD}.t${CYCLE_DATE_HH}z.analysis_assim.forcing.tm${TIME_MINUS_STR}.conus.nc"
            ...
            REMOTE_FILE="nwm.t${CYCLE_DATE_HH}z.analysis_assim.forcing.tm${TIME_MINUS_STR}.conus.nc"
